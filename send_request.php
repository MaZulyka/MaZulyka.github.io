    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="date" class="control-label">Set Date</label>
                    <input type="date" name="date" id="date" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="time" class="control-label">Set Time</label>
                    <input type="time" name="time" id="time" class="form-control form-control-sm rounded-0" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group" style="display:none">
                    <label for="pickup_address" class="control-label">Exact Address/ Notes</label>
